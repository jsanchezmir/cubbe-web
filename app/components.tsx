...
export function Header() {
  return <header className="site-header wrap"><Link className="brand" href="/"><span className="brand-mark"><Image src="/assets/icon/cubbe-mark-light.svg" alt="" width={22} height={22} /></span>Cubbe</Link><nav className="nav"><Link href="/#features">Features</Link><Link href="/#ai">AI assistant</Link><Link href="/support">Support</Link><a href={appStoreUrl}>Download app</a></nav><ThemeToggle /></header>;
}
