    ...
    <main className="page">
      ...
      <section className="hero wrap">
        <div className="hero-content">
          <p className="eyebrow">Your things, finally in order</p>
      ...
      <section className="section" id="features">
        <div className="wrap">
          <div className="section-heading">
            ...
            <h2>Make space for peace of mind.</h2>
            <p>A clear system for the things you already have — from the spare room to the storage unit.</p>
          </div>
      ...
      <section className="section gallery">
        <div className="wrap">
          <div className="section-heading">
            <p className="eyebrow">See Cubbe in action</p>
      ...
      <section className="wrap cta">
        <h2>A better home starts with knowing what you have.</h2>
        <Link className="button button-primary" href="/support">Need a hand? <span>→</span></Link>
      </section>
