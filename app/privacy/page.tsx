...
export default function Privacy() {
  return <main className="page"><Header /><article className="prose wrap"><Link className="back" href="/">← Back to Cubbe</Link><p className="eyebrow">Privacy</p><h1>Privacy policy</h1><p className="updated">Last updated: September 9, 2026</p>
    ...
    <h2>Retention and deletion</h2><p>We retain information for as long as needed to provide the service, comply with legal obligations, resolve disputes, and enforce agreements. You can edit or delete content in the app. To request account or data deletion, contact <a className="text-link" href="mailto:jordisanchezmir@gmail.com">jordisanchezmir@gmail.com</a>.</p>
    ...
    <h2>Contact</h2><p>Questions about privacy can be sent to <a className="text-link" href="mailto:jordisanchezmir@gmail.com">jordisanchezmir@gmail.com</a>.</p>
  </article><Footer /></main>;
}
